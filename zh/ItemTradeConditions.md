...
`ItemTradeConditions.Enabled` 为 1 的物品不使用全局 TradeConditions，仅应用该物品的 PlayerDogtag、AIDogtag 条件。例如全局允许 AI 狗牌，但可让特定 M4A1 仅用 Death Wish 玩家狗牌交易。
